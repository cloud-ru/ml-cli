...
def test_training_api(mock_request, api_client):
    ...
    assert api_client.get_list_jobs('fake_region', '', None, None, 'allocation_name', 'status', 'limit', 'offset') == {'status': 'success'}
    assert api_client.get_list_jobs(
        'fake_region', '00000000-0000-0000-0000-000000000000',  '2024-07-04T10:00:00', '2025-07-04T10:00:00', 'allocation_name', 'status',
        'limit', 'offset',
    ) == {'status': 'success'}
